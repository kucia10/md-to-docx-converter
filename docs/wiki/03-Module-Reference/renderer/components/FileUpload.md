...
## Summary
- **Responsibility**: Provide file selection, drag & drop UI, and file list management
- **Main Users/Callers**: [`App.tsx`](../../../src/renderer/App.tsx:1)
- **Key Entry Point**: [`FileUpload`](../../../src/renderer/components/FileUpload.tsx:22) component

## Location in Architecture
- **Layer**: Renderer Layer (UI Component)
- **Upstream/Downstream Dependencies**:
  - **Dependency**: `components/`, `hooks`, `context`, `types`, `window.electronAPI`
...
1. **Custom Hook Initialization**:
   ...
   - [`useBatchConversion()`](../../../src/renderer/hooks/useBatchConversion.ts): Batch conversion
   - [`useMergeConversion()`](../../../src/renderer/hooks/useMergeConversion.ts): Merge conversion
...
### ConversionOptions Default Values
```typescript
{
...
- [`hooks/useBatchConversion`](../../../src/renderer/hooks/useBatchConversion.ts): Batch conversion
- [`hooks/useMergeConversion`](../../../src/renderer/hooks/useMergeConversion.ts): Merge conversion
- [`hooks/usePreview`](../../../src/renderer/hooks/usePreview.ts): Preview management
...
- **Test Scenarios**:
   - Initial rendering
   - File selection after UI update
